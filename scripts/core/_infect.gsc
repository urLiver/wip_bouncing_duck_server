init()
{
    ...
    level thread on_onplayerconnect();
...
on_onplayerconnect()
{
    for ( ;; )
    {
        ...
        if( rejoined == 0 )
        {
            ...
            var_0.custom_infect_firstspawn = 1;
        }
		else
		{
            var_0.custom_infect_firstspawn = 2;
		}

        var_0 thread maps\mp\gametypes\infect::onplayerdisconnect();
    }
}
